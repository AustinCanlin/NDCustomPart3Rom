...
if [ -e /data/data/com.android.providers.settings/databases/settings.db ]; 
 	then
 	/system/xbin/sqlite3 /data/data/com.android.providers.settings/databases/settings.db "update system set value='Wifi;SilentMode;MobileData;DefaultData;Location;Tomato;Bluetooth;AutoRotate;TorchLight;AirplaneMode;PowerSaving;ScreenCapture;DormantMode;WiFiHotspot;UltraPowerSaving;PersonalMode;AllShareCast;Nfc;Sync;SFinder;SmartStay;MultiWindow;FloatingMessage;QuickConnect;Spo2;SideKey;NetworkBooster;TouchSensitivity' where name='notification_panel_active_app_list'";
fi
if [ -e /data/data/com.android.providers.settings/databases/settings.db ]; 
	then
	/system/xbin/sqlite3 /data/data/com.android.providers.settings/databases/settings.db "update system set value='Wifi;SilentMode;MobileData;DefaultData;Location;Tomato;Bluetooth;AutoRotate;TorchLight;AirplaneMode;PowerSaving;ScreenCapture;DormantMode;WiFiHotspot;UltraPowerSaving;PersonalMode;AllShareCast;Nfc;Sync;SFinder;SmartStay;MultiWindow;FloatingMessage;QuickConnect;Spo2;SideKey;NetworkBooster;TouchSensitivity' where name='notification_panel_active_app_list_for_reset'";
fi
if [ -e /data/data/com.android.providers.settings/databases/settings.db ]; 
 	then
	/system/xbin/sqlite3 /data/data/com.android.providers.settings/databases/settings.db "update system set value='Wifi;SilentMode;MobileData;DefaultData;Location;Tomato;Bluetooth;AutoRotate;TorchLight;AirplaneMode;PowerSaving;ScreenCapture;DormantMode;WiFiHotspot;UltraPowerSaving;PersonalMode;AllShareCast;Nfc;Sync;SFinder;SmartStay;MultiWindow;FloatingMessage;QuickConnect;Spo2;SideKey;NetworkBooster;TouchSensitivity' where name='notification_panel_default_active_app_list'";
fi
if [ -e /data/data/com.android.providers.settings/databases/settings.db ]; 
	then
